...
class ViewController: UIViewController {
    ...
    func doComputer(player:Int) {
        ...
        case 0:
            ...
            switch player {
            case 0: // 가위
                msg = NSLocalizedString("Even", comment:"rdy")
            case 1: // 바위
                msg = NSLocalizedString("Win", comment:"rdy")
                winCountMe += 1
            case 2: // 보
                msg = NSLocalizedString("Lose", comment:"rdy")
                winCountCom += 1
            default:
                break
            }
    ...
    @IBAction func tapStart() {
        ...
        playerImageView.image = UIImage(named: "rock.png")
        // 레이블에 "가위 바위...."를 출력합니다.
        messageLabel.text = NSLocalizedString("Hey Ready...", comment:"rdy") 
