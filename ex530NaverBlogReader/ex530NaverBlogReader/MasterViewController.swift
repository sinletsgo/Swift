...
//        }
        ...
        let usrQuery = "korea polytechnic"
        ...
        request.setValue("u7J2FnD5IUKhb_Upl9A9", forHTTPHeaderField: "X-Naver-Client-Id")
        request.setValue("OCI6cVAbdJ", forHTTPHeaderField: "X-Naver-Client-Secret")
...
//    }
    ...
    var fetchedResultsController: NSFetchedResultsController<Event> {
        ...
        // Edit the sort key as appropriate.  블로그네임순으로 정렬하라
